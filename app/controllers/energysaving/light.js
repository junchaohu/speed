    ...
    '$rootScope', '$scope','$interval','highchartsNG','DashboardService', function($rootScope, $scope,$interval,highchartsNG,DashboardService) {
        ...
        $scope.generateTableData = function(data) {
            ...
            $scope.getDashboardData = function() {
                ...
                DashboardService.getDashboardDataMeter(new Date(new Date().setDate(-15)).toJSON().slice(0,10),new Date().toJSON().slice(0,10),'8b4612c7-36a8-dca9-9dfd-fae7365a7c4a',function(error, data) {
                    if (!error)
                    {
